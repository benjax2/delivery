            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="./index.html"><img
                                src="./assets/img/favicon.jpg" width="50" height="50" class="icon" id="logo">
    ...
    <header class="masthead">
        <div class="container">
            <div class="row h-100 align-items-center justify-content-center text-center">
                 <!-- formulario-->
                <form class="formulario" method="POST" onsubmit="validac()">
                    <h3 style="margin-bottom: 20px;margin-top: -20px;">Registro Local Comercial</h3>
                    <div class="contenedor">
                        ...
                        <div class="input-contenedor">
                            <i class="fas fa-user icon"></i>
                            <input type="text" placeholder="comuna" id="comuna" name="comuna">
                        </div>
                        <div class="input-contenedor">
                            <i class="fas fa-user icon"></i>
                            <input type="text" placeholder="Giro" id="giro" name="giro">
                        </div>
